...
var test;
 ...
 var fillInTheBlank = MQ.MathField(document.getElementById('fillT1'),{
  ...
  handlers :{
  edit: function pol() { latex1 = fillInTheBlank.latex();
  y3=latex1;
  y2=latoj(y3);
  y1=y2.substring(y2.indexOf('a=')+2, y2.lastIndexOf('='));
 ...
 //Secondquestion//		
var latex2="hjk";
 var fillInTheBlank2 = MQ.MathField(document.getElementById('fillT2'),{
   handlers :{
...
//  enter: function() { submitLatex(latex); }
  ...
  function ffunct2(){
	...
	var latex3="hjk";
 var fillInTheBlank3 = MQ.MathField(document.getElementById('ans3.0'),{
   handlers :{
